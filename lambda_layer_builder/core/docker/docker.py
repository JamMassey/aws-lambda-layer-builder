...
def build_and_run_docker_image(dockerfile_path : str, image_name: str, env_variables: Dict = {}, build_args: Dict = {}, remove_container:bool= False, prevent_background_exit:bool = False,publish_all_ports:bool= False, volumes: List=[], detach:bool= False, interactive:bool= False, **kwargs):
